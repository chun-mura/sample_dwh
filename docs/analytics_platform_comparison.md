...
**料金**: スキャン課金 $5/TB（最低 10MB 課金）、Provisioned Capacity $0.30/DPU 時間
...
**料金**: 最低年間 $10M〜（交渉ベース）。コンピュート秒・ストレージ・オントロジーの 3 軸課金
